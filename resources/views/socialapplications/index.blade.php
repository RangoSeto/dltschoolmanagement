            ...
            <table id="mytable" class="table table-sm table-hover border">
                ...
                <tbody>
                    ...
                    <tr id="delete_{{$socialapplication->id}}">
                        ...
                        <td>
                            <a href="javascript:void(0);" class="text-info edit-btns" data-id="{{$socialapplication->id}}" data-name="{{$socialapplication->name}}" data-status="{{$socialapplication->status_id}}"><i class="fas fa-pen"></i></a>
