                        ...
                        <div class="card-body">
                            ...
                            <div class="w-100 d-flex flex-row justify-content-between mb-3">
                                ...
                                <form action="{{route('leads.pipeline',$lead->id)}}" method="POST" class="w-100">
                                    @csrf
                                    @method('POST')
                                    <button type="submit" class="w-100 btn btn-primary btn-sm rounded-0" {{$lead->isconverted() ? 'disabled' :''}}>Pipeline</button>
                                </form>
                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col ps-3">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <div>{{date('d M Y',strtotime($lead->created_at))}} | {{date('h:i:s A',strtotime($lead->created_at))}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row g-0 mb-2">
                                    ...
                                    <div class="col ps-3">
                                        <div class="row">
                                            ...
                                            <div class="col-auto">
                                                <div>{{date('d M Y',strtotime($lead->updated_at))}} | {{date('h:i:s A',strtotime($lead->updated_at))}}</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="accordion">
                                ...
                                <div class="acccontent">
                                    <div class="col-md-12 py-3">
                                        {{-- <form action="{{route('leads.mailbox')}}" method="POST" >
                                            @csrf
                                            <div class="row">
                                                
                                                <div class="col-md-6 form-group mb-3">
                                                    <input type="email" name="cmpemail" id="cmpemail" class="form-control form-control-sm border-0 rounded:0" placeholder="To:" value="{{$lead->user["email"]}}" readonly />
                                                </div>
                                                <div class="col-md-6 form-group mb-3">
